function [rcM,cM,rdM,dM,nuM] = correlationdimensionVer15(xV,tau,mmax,tittxt,fac,logrmin,logrmax);
...
eval(['!/home/chris/Documents/__EKSAMHNO9__/timeseries/ergasia/nonLinear tmp.dat -t50 -d',int2str(tau),' -M1,',int2str(mmax),' -N0 -o tmp'])
